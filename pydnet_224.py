    ...
    def __init__(self, prefix, multiplier, num_init_fts, num_final_fts, cells, channels, dropout=0, classes=10, **kwargs):
        ...
        with self.name_scope():
            ...
            with self.conv0.name_scope():
                ...
                self.conv0.add(nn.Conv2D(num_init_fts, kernel_size=7,
...
# Specification
msmobilenet_spec = {54: (32, [3, 3, 4, 6, 1], [32, 64, 128, 256, 512], 1280),
             } # 20: 3; 56: 6; 110: 18
dropout = 0

def get_pydnet(prefix, num_layers, multiplier, classes=10, **kwargs):
...
def pydnet_0_25(prefix='pydnet_0.25', classes=10, **kwargs):
    return get_pydnet(prefix + '/', 54, 0.25, classes, **kwargs)

def pydnet_0_5(prefix='pydnet_0.5', classes=10, **kwargs):
    return get_pydnet(prefix + '/', 54, 0.5, classes, **kwargs)

def pydnet_0_75(prefix='pydnet_0.75', classes=10, **kwargs):
    return get_pydnet(prefix + '/', 54, 0.75, classes, **kwargs)
